...
exports.SuccessionPage = void 0;
var react_1 = require("react");
var mockData_1 = require("../data/mockData");
var CustodianCard_1 = require("../components/CustodianCard");
var lucide_react_1 = require("lucide-react");
var SuccessionPage = function (_a) {
    var onNavigateHandoff = _a.onNavigateHandoff;
    return (<div className="container" style={{ padding: '3.5rem 2rem 6rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem', marginBottom: '4.5rem' }}>
        <div style={{ width: '100%', display: 'flex', gap: '2rem' }}>
          <CustodianCard_1.CustodianCard custodian={mockData_1.CURRENT_STEWARD} title="Current Primary Steward"/>
        </div>
        ...
        <div style={{
          ...
          <lucide_react_1.ArrowDown size={28} strokeWidth={2}/>
          <span className="label-caps" style={{ fontSize: '0.7rem' }}>Authorized Succession Path</span>
        </div>

        <div style={{ width: '100%', display: 'flex', gap: '2rem' }}>
          <CustodianCard_1.CustodianCard custodian={mockData_1.NEXT_STEWARD} title="Next Designated Steward" isNext/>
        </div>
        ...
        <div className="card-heritage" style={{ width: '100%', textAlign: 'center', padding: '2rem' }}>
          <lucide_react_1.Users size={24} color="var(--c-sage)" style={{ margin: '0 auto 8px' }}/>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2.5rem' }}>
        <div className="card-heritage" style={{ borderLeft: '3px solid var(--c-ochre)' }}>
          ...
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.95rem' }}>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              <lucide_react_1.Key size={18} color="var(--c-ochre)" style={{ marginTop: '2px', flexShrink: 0 }}/>
              <div>
                <strong>Publishing Key:</strong> Current steward (Ngawang Dorje) delegates epoch-signing authority to Sonam Tsering.
              </div>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              <lucide_react_1.RefreshCw size={18} color="var(--c-ochre)" style={{ marginTop: '2px', flexShrink: 0 }}/>
              <div>
        ...
        <div className="card-heritage" style={{ borderLeft: '3px solid var(--c-emerald)' }}>
          ...
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem', fontSize: '0.95rem' }}>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              <lucide_react_1.Globe size={18} color="var(--c-emerald)" style={{ marginTop: '2px', flexShrink: 0 }}/>
              <div>
                <strong>Catalogue Address:</strong> The Swarm feed endpoint reference remains identical for public readers.
              </div>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              <lucide_react_1.Database size={18} color="var(--c-emerald)" style={{ marginTop: '2px', flexShrink: 0 }}/>
              <div>
                <strong>Historical Records:</strong> All 11,842 folios and historical manifests remain unmodified.
              </div>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              <lucide_react_1.Users size={18} color="var(--c-emerald)" style={{ marginTop: '2px', flexShrink: 0 }}/>
              <div>
...
exports.SuccessionPage = SuccessionPage;
