...
var HandoffPage = function () {
    ...
    return (<div className="container" style={{ padding: '3.5rem 2rem 6rem', maxWidth: '980px' }}>
      ...
      <div style={{
        ...
        ].map(function (s) { return (<div key={s.num} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{
                width: 32,
                height: 32,
                borderRadius: '50%',
              ...
              {step > s.num ? <lucide_react_1.Check size={16}/> : "0".concat(s.num)}
            </div>
            <span style={{
                fontSize: '0.78rem',
      ...
      <div className="card-forest" style={{ minHeight: '420px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        {step === 1 && (<div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
              <div style={{ background: 'rgba(0,0,0,0.3)', padding: '1.5rem', borderRadius: 'var(--radius-md)' }}>
                ...
                <h3 style={{ fontSize: '1.3rem', marginTop: '4px' }}>{mockData_1.CURRENT_STEWARD.name}</h3>
                <p style={{ fontSize: '0.8rem', color: 'var(--c-ivory-dark)' }}>{mockData_1.CURRENT_STEWARD.monastery}</p>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1rem' }}>
              <button className="btn btn-primary" onClick={function () { return setStep(2); }}>
        ...
        {step === 2 && (<div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div>
            ...
            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '1.8rem', borderRadius: 'var(--radius-md)', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid var(--c-charcoal-border)', paddingBottom: '0.8rem' }}>
                ...
                <span className="mono">{mockData_1.CURRENT_STEWARD.name} ({mockData_1.CURRENT_STEWARD.publishingAddress.slice(0, 10)}...)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px solid var(--c-charcoal-border)', paddingBottom: '0.8rem' }}>
                <span style={{ color: 'var(--c-ivory-dark)' }}>New Publishing Authority:</span>
                <span className="mono">{mockData_1.NEXT_STEWARD.name} ({mockData_1.NEXT_STEWARD.publishingAddress.slice(0, 10)}...)</span>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem' }}>
              <button className="btn btn-secondary" onClick={function () { return setStep(1); }}>Back</button>
              <button className="btn btn-primary" onClick={function () { return setStep(3); }}>Confirm Transfer & Authorise</button>
            </div>
          </div>)}

        {step === 3 && (<div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div>
            ...
            <div style={{ background: 'rgba(0,0,0,0.3)', padding: '2rem', borderRadius: 'var(--radius-md)', textAlign: 'center' }}>
              <lucide_react_1.Key size={36} color="var(--c-sage)" style={{ margin: '0 auto 1rem' }}/>
              ...
              <button className="btn btn-primary" onClick={handleRunVerification} disabled={isVerifying} style={{ minWidth: '220px' }}>
                {isVerifying ? (<>
                    <lucide_react_1.RotateCw size={16} className="pulse-dot"/>
                    Verifying Signature...
                  </>) : ('Run Verification')}
              </button>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
              <button className="btn btn-secondary" onClick={function () { return setStep(2); }}>Back</button>
            </div>
          </div>)}

        {step === 4 && (<div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: 'rgba(66,159,112,0.1)', padding: '1rem 1.4rem', borderRadius: 'var(--radius-md)' }}>
                <lucide_react_1.CheckCircle2 size={20} color="#72cca1"/>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1rem' }}>
              <button className="btn btn-primary" onClick={function () { return setStep(5); }}>
                Complete Handoff
                <lucide_react_1.ArrowRight size={16}/>
              </button>
            </div>
        ...
        {step === 5 && (<div style={{ textAlign: 'center', padding: '2rem 1rem' }}>
            <div style={{
                width: 72,
                height: 72,
                borderRadius: '50%',
              ...
              <lucide_react_1.ShieldCheck size={36} color="#72cca1"/>
            </div>
            ...
            <button className="btn btn-secondary" onClick={function () { return setStep(1); }}>
...
exports.HandoffPage = HandoffPage;
