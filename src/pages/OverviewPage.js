...
var OverviewPage = function (_a) {
    var onNavigate = _a.onNavigate;
    return (<div style={{ display: 'flex', flexDirection: 'column', gap: '5rem', paddingBottom: '6rem' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2, paddingTop: '3rem' }}>
          <div style={{ maxWidth: '840px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.2rem' }}>
              <button className="btn btn-primary" onClick={function () { return onNavigate('catalogue'); }}>
                View Shared Catalogue
                <lucide_react_1.ArrowRight size={16}/>
              </button>
              <button className="btn btn-secondary" onClick={function () { return onNavigate('succession'); }}>
      ...
      <div className="container" style={{ marginTop: '-4rem', position: 'relative', zIndex: 10 }}>
        <div className="stat-grid">
          <StatCard_1.StatCard value="7" label="Institutions" subtext="Across Ladakh & Spiti"/>
          <StatCard_1.StatCard value="9" label="Years Maintained" subtext={"By ".concat(mockData_1.CURRENT_STEWARD.name)}/>
          <StatCard_1.StatCard value="11,842" label="Folios Catalogued" subtext="Birch, Hemp & Mulberry"/>
          <StatCard_1.StatCard value="100%" label="Storage Continuity" subtext="Swarm Decoupled Feeds"/>
        </div>
      </div>
        ...
        <div className="card-forest" style={{ padding: '4rem 3rem' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '2rem', textAlign: 'left', marginTop: '3rem', borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '2.5rem' }}>
              <div>
                <lucide_react_1.Shield size={22} color="var(--c-sage)" style={{ marginBottom: '12px' }}/>
              ...
              <div>
                <lucide_react_1.Layers size={22} color="var(--c-sage)" style={{ marginBottom: '12px' }}/>
              ...
              <div>
                <lucide_react_1.HeartHandshake size={22} color="var(--c-sage)" style={{ marginBottom: '12px' }}/>
      ...
      <section className="container">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '2.5rem' }}>
          ...
          <button className="btn btn-secondary" onClick={function () { return onNavigate('institutions'); }}>
